...
@Aspect
@Component
public class TicketServiceUpdateByUserAspect {
  ...
  @AfterReturning(
      pointcut = "execution(* com.greenfoxacademy.ticketingsystem.services.SelfService*.updateTicket(..))",
      returning = "result")
  public void afterUpdateTicketAdvice(TicketDto result) {
    activityService.updateActivityByUser(result);
